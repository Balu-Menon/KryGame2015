...
<body>
	...
	<script>
        ...
        $(window).load(function(){
            ...
            $("#quest").load("quests/06ad9dafc40bf934c79c78edf658367c.txt");        
            $("#submitter").click(function(){
                ...
                $.ajax({
                    ...
                    success: function(data, status){
                        ...
                        {
                            FB.api('/me/feed', 'post', {
                                message: "I Just unlocked Level 4 of Kryptos! Can you do better? Prizes worth 15K!!!\nStart Playing Now!\nhttp://kryptos.excelmec.org/\nhttp://excelmec.org/excel2015/",
                                name: "Kryptos 2015",
                            });
