<?php
	...
	if(!isset($_SESSION['usrno']) || $_SESSION['lev']!='level16.php')
	{
...
<body>
	...
	<script>
        ...
        $(window).load(function(){
            ...
            $("#quest").load("quests/0d319d168ac8c723aa3dee5037d2700f.txt");
            ...
            $("#submitter").click(function(){
                ...
                $.ajax({
                    ...
                    success: function(data, status){
                        ...
                        {   
                            FB.api('/me/feed', 'post', {
                                message: "I Just unlocked Level 16 of Kryptos! Can you do better? Prizes worth 15K!!!\nStart Playing Now!\nhttp://kryptos.excelmec.org/",
                                name: "Kryptos 2015",
                            });
