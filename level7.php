<?php
	...
	if(!isset($_SESSION['usrno']) || $_SESSION['lev']!='level7.php')
	{
            ...
            $("#submitter").click(function(){
                ...
                $.ajax({
                    ...
                    success: function(data, status){
                        ...
                        {
                            FB.api('/me/feed', 'post', {
                                message: "I Just unlocked Level 7 of Kryptos! Can you do better? Prizes worth 15K!!!\nStart Playing Now!\nhttp://kryptos.excelmec.org/\nhttp://excelmec.org/excel2015/",
                                name: "Kryptos 2015",
                            });
