...
<body>
    ...
    <!--social-->
    <div class="social">
        <a href="https://www.facebook.com/thekryptosmec" target="_blank" id="soc1" alt="facebook"></a>
    ...
    <div id="wr">
        <font color="#C0C0C0";>
            <h2 id="hc" >WAR RULES</h2>
            <hr>
            <div id="rl">
                <div id="rl">
                    <p id="p">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;If you're in here to play this twisted game, it would help if you gave these guidelines a good look.</p>
                    <div>
                        <ol>
                            <li>Answers can be entered in Uppercase or Lowercase. Spaces are also allowed. It doesn't Matter.</li>
                            <br>
                            <li>Try to keep identities intact, i.e., mention full names for anything you enter. Eg. If the answer is Chandler Bing, then your entry should be 'chandlermurielbing'.</li>
                            <br>
