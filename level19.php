<?php
    ...
    else if($_SESSION['lev']=='level18.php') {
        header('Location:approve19.php');
    }
    else if($_SESSION['lev']!='level19.php') {
        header('Location:validate.php');
    }
	else 
	{
...
<body>
	...
	<script>
        ...
        $(window).load(function(){
            ...
            $("#quest").load("quests/50f4e8a429f2fac830602cccbcd62fab.txt");        
            $("#submitter").click(function(){
                ...
                $.ajax({
                    ...
                    success: function(data, status){
                        ...
                        {
                            FB.api('/me/feed', 'post', {
                                message: "I Just unlocked Level 19 of Kryptos! Can you do better? Prizes worth 15K!!!\nStart Playing Now!\nhttp://kryptos.excelmec.org/",
                                name: "Kryptos 2015",
                            });
