<?php
	...
	if(!isset($_SESSION['usrno']) || $_SESSION['lev']!='level25.php')
	{
...
<body>
	...
	<script>
        ...
        $(window).load(function(){
            ...
            $("#quest").load("quests/b8869f5dc3c4818b02d938ce7ef3b75b.txt");
            $("#submitter").click(function(){
                ...
                $.ajax({
                    ...
                    success: function(data, status){
                        ...
                        {
                            FB.api('/me/feed', 'post', {
                                message: "I Just unlocked Level 25 of Kryptos! Can you do better? Prizes worth 15K!!!\nStart Playing Now!\nhttp://kryptos.excelmec.org/\nhttp://excelmec.org/excel2015/\n#Kryptos2015\n#Addicted",
                                name: "Kryptos 2015",
                            });
