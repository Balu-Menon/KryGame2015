...
<body>
	...
	<script>
        ...
        $(window).load(function(){
            ...
            $("#quest").load("quests/f34cc544bfb57c92609f70044c4e8628.txt");        
            $("#submitter").click(function(){
                ...
                $.ajax({
                    ...
                    success: function(data, status){
                        ...
                        {
                            /*FB.api('/me/feed', 'post', {caption: "Online Treasure Hunt: Excel2015", message: 'I Just unlocked Level 1 of Kryptos! Can you do better? Prizes worth 15K!!!', link: 'http://kryptos.excelmec.org', name: "Kryptos", picture: "http://kryptos.excelmec.org/images/favicon.png.pagespeed.ce.YLmIxTciuu.png"});*/
