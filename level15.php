<?php
	...
	if(!isset($_SESSION['usrno']) || $_SESSION['lev']!='level15.php')
	{
    ...
    <div id='wrap'>
        <div id='content'>
            <section class='input'>
                <div>
                    <div id="quest">
                        <h2 style="color:#1C1C1C;padding-top:7%;">GZGNYZKIZ</h2>
                    </div>
                    <!--lauryn hill-->
                    <form>
            ...
            $("#submitter").click(function(){
                ...
                $.ajax({
                    ...
                    success: function(data, status){
                        ...
                        {
                            FB.api('/me/feed', 'post', {
                                message: "I Just unlocked Level 15 of Kryptos! Can you do better? Prizes worth 15K!!!\nStart Playing Now!\nhttp://kryptos.excelmec.org/\nhttp://excelmec.org/excel2015/",
                                name: "Kryptos 2015",
                            });
