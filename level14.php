<?php
	...
	if(!isset($_SESSION['usrno']) || $_SESSION['lev']!='level14.php')
	{
...
<body>
	...
	<script>
        ...
        $(window).load(function(){
            ...
            $("#quest").load("quests/8ec01c2b1ab5ec2c10f8b10a2a929564.txt");
            ...
            $("#submitter").click(function(){
                ...
                $.ajax({
                    ...
                    success: function(data, status){
                        ...
                        {   
                            FB.api('/me/feed', 'post', {
                                message: "I Just unlocked Level 14 of Kryptos! Can you do better? Prizes worth 15K!!!\nStart Playing Now!\nhttp://kryptos.excelmec.org/",
                                name: "Kryptos 2015",
                            });
