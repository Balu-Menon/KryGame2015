<?php
    ...
    $value="XRLJBEQ";
    setcookie($value,"1pj3pe71k4vktfma6s2edl1dc2",time()+3600*24*10,"/kryptos/level24.php");
	
    if(!isset($_SESSION['usrno']) || $_SESSION['lev']!='level24.php')
	{
        ...
        <div id='content'>
            <section class='input'>
                <div>
                    <div id="quest">
                        <!--N3dcOX-->
                        <h3 style="color:white;">DKOAMASTJYAKOAZRZPGOFWISDOYLSIMCJOND</h3>
                    </div>
                    <form>
            ...
            $("#submitter").click(function(){
                ...
                $.ajax({
                    ...
                    success: function(data, status){
                        ...
                        {
                            FB.api('/me/feed', 'post', {
                                message: "I Just unlocked Level 24 of Kryptos! Can you do better? Prizes worth 15K!!!\nStart Playing Now!\nhttp://kryptos.excelmec.org/\nhttps://www.facebook.com/excelmec\n#Kryptos2015\n#Addicted",
                                name: "Kryptos 2015",
                            });
