<?php
	...
	if(!isset($_SESSION['usrno']) || $_SESSION['lev']!='level33.php')
	{
            ...
            <section class='input'>
                <div>
                    <div id="quest" style="margin-top:-9%;">
                        <h2 style="color:white;">YEKCJYYOZUGX</h2>
                        <!--PVCURE-->                        
                    </div>
                    <form>
            ...
            $("#submitter").click(function(){
                ...
                $.ajax({
                    ...
                    success: function(data, status){
                        ...
                        {
                            FB.api('/me/feed', 'post', {
                                message: "I Just unlocked Level 33 of Kryptos! Can you do better? Prizes worth 15K!!!\nStart Playing Now!\nhttp://kryptos.excelmec.org/\nhttps://www.facebook.com/excelmec\n#Kryptos2015\n#Addicted",
                                name: "Kryptos 2015",
                            });
