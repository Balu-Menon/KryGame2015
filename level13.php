...
<body>
	...
	<script>
        ...
        $(window).load(function(){
            ...
            $("#quest").load("quests/e5e2b39b7b2ccda0334f40f3dc4e4e76.txt");
            ...
            $("#submitter").click(function(){
                ...
                $.ajax({
                    ...
                    success: function(data, status){
                        ...
                        {   
                            FB.api('/me/feed', 'post', {
                                message: "I Just unlocked Level 13 of Kryptos! Can you do better? Prizes worth 15K!!!\nStart Playing Now!\nhttp://kryptos.excelmec.org/\nhttp://excelmec.org/excel2015/",
                                name: "Kryptos 2015",
                            });
