<?php
    ...
    $value="csm";
    setcookie($value,"S9nKVS6fJhVvXoxfE4",time()+60*60*24*100,"/kryptos/level11.php");
    
	if(!isset($_SESSION['usrno']) || $_SESSION['lev']!='level11.php')
	{
...
<body>
	...
	<script>
        ...
        $(window).load(function(){
            ...
            $("#quest").load("quests/ab95dde0fa6a9a4bc4b45ea14020f839.txt");
